...
import fr.xebia.xke.fp5.serialization.persistance.Persister.persist
import fr.xebia.xke.fp5.serialization.persistance.httpservice.HttpServicePersistance
